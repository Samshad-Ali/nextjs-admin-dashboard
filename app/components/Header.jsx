...
const Header = () => {
    const isAuthenticated = selecter(state=>state.dashboardReducer.isAuthenticated);
  ...
  return (
    <div className='flex justify-between items-center h-16 text-white sticky shadow-md shadow-black/20 z-10 bg-secondaryClr top-0 p-2 sm:p-4'>
        ...
        <button className='hover:bg-secondaryClr hover:border hover:text-white bg-white duration-200 w-fit text-secondaryClr py-2 px-4 rounded-sm text-sm font-semibold'
